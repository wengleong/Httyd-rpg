...
const EGG_DRAGONS = [
  ...
  { id: "tw_flarejet",   name: "Titan Flarejet",   emoji: "🌋", rarity: "Titanwing", chance: 0.5, stats: { hp: 175, attack: 102, defense: 70,  speed: 95  }, ability: "Twin Inferno Jets", class: "Ember Class",  description: "A colossal twin-tailed fire-drake that rockets on jets of flame. Krogan tamed one from the clutch and rides it into every battle." },
  // LEGENDARY
...
const LOCATIONS = [
  ...
  { id: "krogans_roost",    name: "Krogan's Roost",              emoji: "🦅", minLevel: 22, description: "A volcanic crater-isle where Krogan breeds Titan Flarejets in caged clutches — and rides the fiercest of them into battle. The air reeks of ash and cruelty. Free the drakes, and bring Krogan and his titan down.", characters: ["Krogan"], enemies: ["Krogan's Berserker", "Drake Hunter Warrior", "Krogan"] },
];
...
const CHARACTERS = {
  ...
  Krogan: { emoji: "🦅", lines: ["My Titan Flarejet answers to no one but me — you would be wise to do the same.", "Viggo thinks in chess pieces. I think in armies.", "You've come far. That ends here.", "I've broken stronger riders than you. My titan has broken the rest."] },
...
const ENEMIES = [
  ...
  { id: "krogan",          name: "Krogan",                  emoji: "🦅", hp: 280, attack: 56, defense: 36, xp: 750, gold: 320, loot: ["krogans_weapon", "viggos_sword_2", "dragon_scale_mail", "dragonite_plating"] },
...
const DRAKE_COLORS = {
  ...
  tw_flarejet:   { hex: "#E2662B", name: "Roost Ember" },
                ...
                <div key={idx} className="card" style={{ border: idx === activeDragonIdx ? "1px solid #4db8ff66" : undefined }}>
                  <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      {d.description && <div style={{ fontSize: "11px", opacity: 0.6, fontStyle: "italic", marginBottom: "8px", lineHeight: "1.5" }}>{d.description}</div>}
